...
/**
 * Job export status request class.
 */
public class GetImportJobExportStatusRequest implements Request<GetImportJobExportStatusResponse> {
    private Long importJobId;
    private Long jobExportId;

    public GetImportJobExportStatusRequest(final Builder builder) {
    ...
    public static Builder getImportJobExportStatus() {
        return new Builder();
    }
    ...
    public static class Builder {
        ...
        public GetImportJobExportStatusRequest build() {
            return new GetImportJobExportStatusRequest(this);
        }
    }
}
