 ...
 */
public class GetAllImportOperationsRequestValidator implements RequestValidator<GetAllImportOperationsRequest> {

    @Override
    public List validate(final GetAllImportOperationsRequest request) {
        return NO_ERRORS;
    }
}
